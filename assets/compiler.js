...
(function () {
  ...
  var PROJECTS = {
    "flow-wing": {
      title: "Flow-Wing — programming language",
      tag: "C++ · LLVM",
    ...
    eimentum: {
      title: "Eimentum — social platform",
      tag: "MERN",
  ...
  var COMMANDS = {
    help: function () {
      ...
      line([
        ["o-dim", "  hidden: "],
        ["o-dim", "sudo hire · neofetch · date · echo"],
      ]);
    },
    ...
    whoami: function () {
      ...
      line([
        ["o-dim", "role     "],
        "Full-Stack Engineer @ Badho Technologies",
      ]);
      line([
        ["o-dim", "edge     "],
        "author of the ",
      ...
      line([
        ["o-dim", "stack    "],
        "C++ · TypeScript · React/RN · Node · PostgreSQL · AWS",
      ]);
      blank();
    ...
    skills: function (a) {
      ...
      if (k && !cats[k])
        line([
          ["o-err", "  no such category — try: "],
          "languages frameworks infra concepts",
        ]);
    },
    ...
    projects: function () {
      ...
      line([
        ["o-dim", "  → "],
        "open <name>",
        ["o-dim", "  for the deep-dive"],
      ]);
    },

    open: function (a) {
      return projectDetail(a[0]);
    },
    project: function (a) {
      return projectDetail(a[0]);
    },
    ...
    impact: function () {
      ...
      [
        [
          "−11%",
          "RDS cost",
          "blue-green migration · pg_repack · Athena/S3 archive",
        ],
        ...
        [
          "−40%",
          "Hasura tables",
          "untracked redundant tables, pruned millions of logs",
        ],
        [
          "1M/d",
          "BigQuery cap beat",
          "intraday backups, unified queries, 0 data loss",
        ],
        [
          "AI",
          "automation",
          "TypeSense catalogue match · Mistral OCR invoices",
        ],
      ].forEach(function (r) {
        line([
          ["o-ok", "  " + r[0].padEnd(7)],
    ...
    flowwing: function () {
      return projectDetail("flow-wing");
    },
    ...
    server: function () {
      ...
      line([
        ["o-dim", "  $ "],
        ["o-acc", "flowwing-jit server.fg"],
        ["o-dim", "      # JIT"],
      ]);
      line([
        ["o-dim", "  $ "],
        ["o-acc", "flowwing server.fg -o career"],
        ["o-dim", "  # AOT"],
      ]);
      ...
      line([
        ...
        [
          "o-acc",
          "github.com/kushagra1212/Flow-Wing",
          "https://github.com/kushagra1212/Flow-Wing",
        ],
      ]);
    },
    ...
    source: function () {
      ...
      blank();
      line([
        "Real Flow-Wing — compiles & runs on ",
        [
          "o-acc",
      ...
      line([
        ["o-dim", "try "],
        ["o-acc", 'run println("hi from flow-wing")'],
      ]);
    },
    ...
    cp: function () {
      ...
      line([
        ["o-acc", "  CodeChef    "],
        "max 1908 · 4★ · #38 global, Sept CookOff ’21",
      ]);
      line([["o-acc", "  LeetCode    "], "rating 1851"]);
      line([["o-acc", "  Volume      "], "1,600+ problems across platforms"]);
      line([
        ["o-acc", "  Mentorship  "],
        "Google DSC CP mentor · CodeChef problem-setter (c. 2021–22)",
      ]);
    },
    ...
    education: function () {
      ...
      line([
        ["o-acc", "  Activities  "],
        "organized contests · CP mentor · problem-setter",
      ]);
    },
    ...
    contact: function () {
      ...
      line([
        ...
        [
          "o-acc",
          "kushagrarathore002@gmail.com",
          "mailto:kushagrarathore002@gmail.com",
        ],
      ]);
      line([
        ["o-dim", "  phone     "],
        ["o-acc", "+91 97559 12802", "tel:+919755912802"],
      ]);
      line([
        ["o-dim", "  github    "],
        ["o-acc", "github.com/kushagra1212", "https://github.com/kushagra1212"],
      ]);
      line([
        ["o-dim", "  linkedin  "],
        [
          "o-acc",
          "linkedin.com/in/kushagra1212",
          "https://www.linkedin.com/in/kushagra1212",
        ],
      ]);
      line([
        ["o-dim", "  leetcode  "],
        [
          "o-acc",
          "leetcode.com/u/kushagra1212",
          "https://leetcode.com/u/kushagra1212",
        ],
      ]);
      line([
        ["o-dim", "  medium    "],
        [
          "o-acc",
          "medium.com/@kushagrarathore002 — articles",
          "https://medium.com/@kushagrarathore002",
        ],
      ]);
    },
    ...
    resume: function () {
      ...
      line(
        "  DocsUp Pvt Ltd     — Full-Stack Intern          Oct 2021 — Jan 2022",
      );
      blank();
      line([["o-dim", "PROJECT"]]);
      ...
      line([
        ...
        [
          "o-acc",
          "view résumé — Google Drive ↗",
          "https://drive.google.com/file/d/17zyixC8Zl0CulGMdi2onaBDnd5dJWuov/view?usp=sharing",
        ],
      ]);
    },
    ...
    cat: function (a) {
      ...
      var key = Object.keys(FS).filter(function (k) {
        return k.toLowerCase().indexOf(f.toLowerCase()) === 0;
      })[0];
    ...
    theme: function (a) {
      ...
      if (s !== "blue" && s !== "green")
        return line([["o-err", "usage: theme blue|green"]]);
    ...
    echo: function (a, raw) {
      line(raw.replace(/^echo\s?/, ""));
    },
    date: function () {
      line([["o-dim", new Date().toString()]]);
    },
    history: function () {
      head("history");
      ...
      if ((a[0] || "") === "hire") {
        ...
        line([
          [
            "o-acc",
            "  → kushagrarathore002@gmail.com",
            "mailto:kushagrarathore002@gmail.com?subject=Let%27s%20build%20something",
          ],
        ]);
        line([
          [
            "o-dim",
            "  mention ‘Career Compiler’ in the subject — I’ll reply fast.",
          ],
        ]);
        return;
      }
  ...
  function projectDetail(name) {
    ...
    var match =
      PROJECTS[k] ||
      PROJECTS[
        Object.keys(PROJECTS).filter(function (x) {
          return (
            x.indexOf(k) === 0 ||
            PROJECTS[x].title.toLowerCase().indexOf(k) > -1
          );
        })[0]
      ];
    if (!match)
      return line([
        ["o-err", "open: '" + name + "' not found — try `projects`"],
      ]);
    head(match.title);
    line([["o-type", "  [" + match.tag + "]"]]);
    blank();
    match.lines.forEach(function (l) {
      line(["  " + l]);
    });
    blank();
    if (match.site)
      line([["o-acc", "  → " + match.site + "  (live)", match.site]]);
  ...
  function fgRun(src) {
    ...
    if (!src)
      return line([
        ["o-dim", 'fg: nothing to run — e.g. run print("hi"), run 6*7'],
      ]);
    try {
      var m;
      if (
        (m = src.match(/^(?:var\s+)?([A-Za-z_]\w*)\s*=\s*(.+)$/)) &&
        src.indexOf("==") === -1
      ) {
  ...
  function runFlowWing(src) {
    ...
    if (!src) {
      line([
        ["o-dim", 'fg: nothing to run — e.g. run println("hi")  ·  run 6*7'],
      ]);
      return;
    }
    ...
    fetch(ep, {
      ...
      body: JSON.stringify({ code: program, input: "" }),
      signal: ctl.signal,
    })
      .then(function (r) {
      ...
      .catch(function () {
        ...
        line([
          [
            "o-dim",
            "remote engine not reachable from this origin — local sandbox:",
          ],
        ]);
        fgRun(src);
        out.scrollTop = out.scrollHeight;
  ...
  function exec(raw) {
    ...
    if (cmd === "run") {
      runFlowWing(raw.replace(/^run\s?/i, ""));
      out.scrollTop = out.scrollHeight;
      return;
    }
    ...
    if (fn) {
      var cleared = fn(args, raw);
      if (!cleared) tail();
    } else {
      line([["o-err", "command not found: " + cmd]]);
      line([
        ["o-dim", "try `help` — or `run " + raw + "` to execute as Flow-Wing"],
      ]);
      tail();
    }
    function tail() {
  ...
  inp.addEventListener("keydown", function (e) {
    if (e.key === "Enter") {
      ...
      var hit = pool.filter(function (c) {
        return c.indexOf(cur) === 0;
      });
      if (hit.length === 1) inp.value = hit[0] + " ";
      else if (hit.length > 1) {
        line([["o-dim", "  " + hit.sort().join("   ")]]);
        out.scrollTop = out.scrollHeight;
      }
  ...
  if (ide)
    ide.addEventListener("click", function (ev) {
      if (ev.target.tagName !== "A" && window.getSelection().toString() === "")
        inp.focus();
    });
  ...
  line([
    ["o-dim", "career data lives in "],
    ["o-kw", "career.fg"],
    ["o-dim", " ("],
    ["o-acc", "source"],
    ["o-dim", "). "],
    ["o-acc", "run"],
    ["o-dim", " executes real Flow-Wing"],
  ]);
  line([
    ["o-dim", "via the same engine as "],
    [
      "o-acc",
      "flowwing.kushagrarathore.in",
      "https://flowwing.kushagrarathore.in/",
    ],
    ["o-dim", " (local sandbox if offline)."],
  ]);
  blank();
  line([
    ["o-dim", "type "],
